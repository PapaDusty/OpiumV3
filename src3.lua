...
function library:Window(Info)
    ...
    function insidewindow:ModuleButton(Info)
        ...
        -- Expand arrow (right side) - now an ImageButton to allow MouseButton1Click
        ...
        -- Helper to create a keybind control (used both for automatic bottom bind and custom keybinds)
        ...
        -- Function to add a custom setting control
    ...
    -- These remain unchanged from original
    -- ============================================================
