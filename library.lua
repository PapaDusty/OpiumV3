-- Revenant Library (Module System Refactor)
...
function library:Window(Info)
    ...
    -- ============================================================
    -- INTERNAL: Module Settings Window (popup on right-click)
    -- ============================================================
    local function CreateModuleSettingsWindow(moduleName, parentGui)
        -- Create a separate small window for module settings
        local settingsGui = Instance.new("ScreenGui")
        settingsGui.Name = "ModuleSettings_" .. moduleName
        settingsGui.Parent = parentGui or game:GetService("CoreGui")
        settingsGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        settingsGui.Enabled = true

        local settingsFrame = Instance.new("Frame")
        settingsFrame.Name = "SettingsFrame"
        settingsFrame.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
        settingsFrame.BorderSizePixel = 0
        settingsFrame.Position = UDim2.fromOffset(Mouse.X + 10, Mouse.Y + 10)
        settingsFrame.Size = UDim2.fromOffset(200, 0)
        ...
        settingsTitle.Text = moduleName .. " Settings"
        settingsTitle.TextColor3 = Color3.fromRGB(214, 214, 214)
        settingsTitle.TextSize = 13
        settingsTitle.BackgroundColor3 = Color3.fromRGB(36, 36, 36)
        settingsTitle.BorderSizePixel = 0
        settingsTitle.Size = UDim2.new(1, 0, 0, 28)
        settingsTitle.Parent = settingsFrame

        local settingsTitleCorner = Instance.new("UICorner")
        settingsTitleCorner.CornerRadius = UDim.new(0, 4)
        ...
        settingsContainer.Position = UDim2.new(0, 0, 0, 28)
        ...
        settingsListLayout.Padding = UDim.new(0, 2)
        ...
        local function UpdateSettingsSize()
            settingsFrame.Size = UDim2.new(0, 200, 0, 28 + settingsSize)
            settingsContainer.Size = UDim2.new(1, 0, 0, settingsSize)
        end

        local settingsAPI = {}

        -- Small Toggle for settings
        function settingsAPI:Toggle(Info)
            ...
            innerFrame.Position = Info.Default and UDim2.new(0, 15, 0, 1) or UDim2.new(0, 2, 0, 1)
            ...
            settingsSize = settingsSize + 24
            UpdateSettingsSize()
        end

        -- Small Slider for settings
        function settingsAPI:Slider(Info)
            ...
            settingsSize = settingsSize + 38
            UpdateSettingsSize()
        end

        -- Small Keybind for settings
        function settingsAPI:Keybind(Info)
            ...
            keybind.Parent = settingsContainer
        ...
        -- Small Button for settings (for actions inside module settings)
        function settingsAPI:Button(Info)
        ...
        -- Small Label for settings
        function settingsAPI:Label(Info)
            ...
            settingsSize = settingsSize + 20
            UpdateSettingsSize()
        end

        -- Dropdown for settings
        function settingsAPI:Dropdown(Info)
            ...
            local function AddOption(optionText)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    pcall(Info.Callback, optionText)
                    dropdownText.Text = Info.Text .. ": " .. optionText
                    Opened = false
        ...
        UserInputService.InputBegan:Connect(CheckOutsideClick)

        return settingsAPI
    end

    -- ============================================================
    -- MODULE BUTTON (Left-click = action, Right-click = settings)
    -- ============================================================
    function insidewindow:ModuleButton(Info)
        ...
        moduleText.TextSize = 16  -- Bigger text for modules
        ...
        -- Indicator arrow for settings
        local settingsIndicator = Instance.new("ImageLabel")
        settingsIndicator.Name = "SettingsIndicator"
        settingsIndicator.Image = "rbxassetid://7733717447"
        settingsIndicator.ImageColor3 = Color3.fromRGB(129, 129, 129)
        settingsIndicator.BackgroundTransparency = 1
        settingsIndicator.Position = UDim2.new(1, -18, 0.5, -8)
        settingsIndicator.Size = UDim2.fromOffset(14, 14)
        settingsIndicator.Rotation = 90
        settingsIndicator.Parent = moduleButton

        -- Left-click: Execute callback
        local clickButton = Instance.new("TextButton")
        clickButton.Name = "ClickButton"
        clickButton.Text = ""
        clickButton.BackgroundTransparency = 1
        ...
        clickButton.MouseButton2Click:Connect(function()
            local settingsWindow = CreateModuleSettingsWindow(Info.Text, revenant.Parent)
            -- Build settings from Info.Settings
            for _, setting in ipairs(Info.Settings) do
                ...
                if settingType == "Toggle" then
                    settingsWindow:Toggle({
                        ...
                        Flag = setting.Flag,
                        Default = setting.Default or false,
                ...
                elseif settingType == "Slider" then
                    settingsWindow:Slider({
                        ...
                        Flag = setting.Flag,
                        Postfix = setting.Postfix or "",
                        Minimum = setting.Minimum or 1,
                        Default = setting.Default or 5,
                        Maximum = setting.Maximum or 100,
                        Callback = setting.Callback or function() end
                    })
                elseif settingType == "Keybind" then
                    settingsWindow:Keybind({
                        Text = setting.Text or "Keybind",
                        Default = setting.Default or Enum.KeyCode.LeftAlt,
                        Callback = setting.Callback or function() end
                    })
                ...
                elseif settingType == "Label" then
                    settingsWindow:Label({
                        Text = setting.Text or "Label",
                        Color = setting.Color or Color3.fromRGB(214, 214, 214)
                    })
                elseif settingType == "Dropdown" then
                    settingsWindow:Dropdown({
                        Text = setting.Text or "Dropdown",
                        List = setting.List or {},
                        Callback = setting.Callback or function() end
                    })
                end
            end
        ...
        moduleButton.MouseEnter:Connect(function()
            moduleFixLine.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
    ...
    -- ============================================================
    -- STANDARD BUTTON (For use inside module settings or as standalone)
    -- ============================================================
