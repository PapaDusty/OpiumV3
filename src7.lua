...
function library:Window(Info)
    ...
    tabBackground.BackgroundColor3 = Color3.fromRGB(36, 36, 36)
    tabBackground.BorderSizePixel = 0
    tabBackground.ClipsDescendants = false
    tabBackground.Position = UDim2.fromScale(0, 1)
    tabBackground.Size = UDim2.fromOffset(windowWidth, 0)
    tabBackground.Parent = topbar

    local tabCorner = Instance.new("UICorner")
    tabCorner.Name = "UICorner"
    tabCorner.CornerRadius = UDim.new(0, 4)
    tabCorner.Parent = tabBackground
    ...
    moduleArea.Parent = tabBackground

    moduleArea.ChildAdded:Connect(function(v)
        if v.ClassName ~= "UIListLayout" then
            tabBackground.Size = UDim2.new(0,windowWidth,0,moduleArea.Size.Y.Offset + 38)
    ...
    function insidewindow:Module(Info)
        ...
        buttonFrame.Parent = moduleContainer
        ...
        local function createKeybindControl(parent, info, onBind)
            ...
            -- Listen for the keybind to toggle the module (if applicable)
        ...
        function moduleAPI:CreateMultiDropdown(info)
            ...
            multiddContainer.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        ...
        -- Add a default keybind at the bottom
        local function addDefaultKeybind()
            local onBind = function(key)
                moduleKeybind = key
                keybindDisplay.Text = key.Name
            end
            createKeybindControl(moduleOptions, {Text = "Keybind", Default = moduleKeybind}, onBind)
            optionsHeight = optionsHeight + 28
            moduleOptions.Size = UDim2.new(1, 0, 0, optionsHeight + 4)
        end
        addDefaultKeybind()
        ...
        local function toggleExpand()
            ...
            tabBackground.Size = UDim2.new(0, windowWidth, 0, totalHeight)
    ...
    -- ============================================================
    -- STANDARD BUTTON (for settings tab, etc.)
    -- ============================================================
    ...
    -- ============================================================
    -- Topbar elements (TabName, Chevron)
    -- ============================================================
    ...
    chevron.MouseButton1Click:Connect(function()
        ...
        tabBackground.ClipsDescendants = WindowOpened.Value and false or true
        TweenService:Create(tabBackground, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Size = WindowOpened.Value and UDim2.new(0, windowWidth, 0, BackgroundSize) or UDim2.new(0, windowWidth, 0, 0)}):Play()
