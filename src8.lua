...
function library:Window(Info)
    ...
    -- Track expanded module for this window (to collapse others)
    ...
    function insidewindow:Module(Info)
        ...
        -- FixLine inside module (recovered)
        ...
        local function createKeybindControl(parent, info, onBind)
            ...
            UserInputService.InputBegan:Connect(function(Key, gameProcessed)
                if not Changing and Key.KeyCode == PressKey and not gameProcessed then
                    ...
                    -- Also toggle the module if this is the default keybind
        ...
        function moduleAPI:CreateDropdown(info)
            ...
            -- Outline for the entire dropdown (header + options)
        ...
        -- Add the default keybind LAST, after all user components
        local function addDefaultKeybind()
            ...
            createKeybindControl(moduleOptions, {
                ...
                ToggleModule = true,
                Callback = function()
                    -- This callback is triggered when the key is pressed
                    -- The ToggleModule flag will handle the toggle in the listener
                end
            }, onBind)
            optionsHeight = optionsHeight + 28
            moduleOptions.Size = UDim2.new(1, 0, 0, optionsHeight + 4)
        ...
        -- Add default keybind after all user components
        addDefaultKeybind()
    ...
    -- ============================================================
    -- STANDARD BUTTON (for settings tab)
    -- ============================================================
    ...
    -- Function to toggle tab expanded state
    ...
    -- Right-click on topbar toggles tab
    topbar.MouseButton2Click:Connect(toggleTab)
